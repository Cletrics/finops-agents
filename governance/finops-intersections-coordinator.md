...
color: "#14B8A6"
emoji: 🔗
vibe: Three separate teams pulling the same CUR is a smell, not a signal of rigor.
fcp_domain: "Manage the FinOps Practice"
fcp_capability: "Intersecting Disciplines"
fcp_phases: ["Operate"]
fcp_personas_primary: ["FinOps Practitioner"]
fcp_personas_collaborating: ["ITAM","ITSM","ITFM","Security","Sustainability"]
